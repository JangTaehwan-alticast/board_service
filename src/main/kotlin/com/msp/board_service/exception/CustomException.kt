...
class CustomException : Exception {
    ...
    companion object{
        ...
        fun exceedMaxValue(field:String,param:String,length:Int) = CustomException("The length of the $field($param) exceeds the maximum value.(max: $length Characters include blank)",3260001)
    }
